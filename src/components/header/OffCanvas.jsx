...
export default function OffCanvas(props) {
    return (
        <div className={`offcanvas__area offcanvas__radius ${props.open}`}>
            <div className="offcanvas__wrapper">
                <div className="offcanvas__close">
                    <button className="offcanvas__close-btn offcanvas-close-btn" onClick={()=>props.setOpenMob('')}>
                        <svg
                            width={12}
                            height={12}
                            viewBox="0 0 12 12"
                        ...
                        <div className="offcanvas__select language">
                            <div className="offcanvas__lang d-flex align-items-center justify-content-md-end">
                                <div className="offcanvas__lang-img mr-15">
                                    <img src="images/language-flag.png" alt="" />
                                </div>
